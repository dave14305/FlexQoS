...
var $addTextHtml = $("<div>").html("Add " + _tableNameText + " ( Max Limit : " + _createRuleCount + " )").addClass("addRuleText");
...
alert("This table only allows " + _createRuleCount + " items!");
return;
}
...
$titleHtml.html("Create New Rule");/*untranslated*/
...
$actionButtonCancelHtml.html("Cancel");
...
$(this).closest(".editFrame").siblings('.table_clientlist_dropdown').children(".clientList_offline_expand").html("Show Offline Client List");
...
$offlineExpandHtml.html("Show Offline Client List");
...
$(this).html("Hide Offline Client List");
}
else {
$(this).siblings(".clientList_offline").slideUp();
$(this).html("Show Offline Client List");
}
}
);
...
if(!validDuplicateFlag) {
tableApi.showHintMsg($(this), "This entry already exists.");
return false;
}
}
